...
(()=>{
  ...
  openViewer=async function(id){
    const loadId=++documentLoadId;remoteDocument=null;document.querySelector("#documentCanvas")?.remove();appOpenViewer(id);const material=materials.find(x=>x.id===id);if(!material?.filePath)return;
